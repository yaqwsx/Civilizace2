# Generated by Django 3.0.6 on 2021-06-17 20:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='enhanceruseinputmodel',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='use_inputs', to='game.EnhancerModel'),
        ),
        migrations.AddField(
            model_name='enhanceruseinputmodel',
            name='resource',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='use_input_to_enhancements', to='game.ResourceModel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='enhancerdeployinputmodel',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deploy_inputs', to='game.EnhancerModel'),
        ),
        migrations.AddField(
            model_name='enhancerdeployinputmodel',
            name='resource',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deploy_input_to_enhancements', to='game.ResourceModel'),
        ),
        migrations.AddField(
