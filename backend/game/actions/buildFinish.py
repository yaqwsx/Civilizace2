...
class BuildFinishAction(TeamInteractionActionBase):
    ...
    def cost(self) -> Dict[Resource, Decimal]:
        return (
            self.state.world.buildDemolitionCost if self.args.demolish != None else {}
        )
