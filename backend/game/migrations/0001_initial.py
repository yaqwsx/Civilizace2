    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.dbtask')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('team', 'task'), name='unique_assignment'),
        ),
    ]
