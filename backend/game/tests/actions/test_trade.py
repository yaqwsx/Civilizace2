...
def test_cost():
    ...
    cost = makeAction(
        ...
        entities=entities,
        args=TradeArgs(
            team=teamId, receiver=TEAM_ADVANCED, resources={entities["pro-bobule"]: 2}
        ),
    ).cost()
    ...
    cost = makeAction(
        ...
        entities=entities,
        args=TradeArgs(
            team=teamId, receiver=TEAM_ADVANCED, resources={entities["pro-cukr"]: 1}
        ),
    ).cost()
    ...
    cost = makeAction(
        ...
        entities=entities,
        args=TradeArgs(
            team=teamId, receiver=TEAM_ADVANCED, resources={entities["pro-drevo"]: 3}
        ),
    ).cost()
    ...
    cost = makeAction(
        ...
        args=TradeArgs(
            team=teamId,
            receiver=TEAM_ADVANCED,
            resources={entities["pro-drevo"]: 3, entities["pro-maso"]: 2},
        ),
    ).cost()
    ...
    cost = makeAction(
        ...
        args=TradeArgs(
            team=teamId,
            receiver=TEAM_ADVANCED,
            resources={entities["pro-drevo"]: 3, entities["pro-cukr"]: 2},
        ),
    ).cost()
...
def test_success():
    ...
    result = makeAction(
        ...
        args=TradeArgs(
            team=teamId,
            receiver=TEAM_ADVANCED,
            resources={entities["pro-bobule"]: 2, entities["pro-drevo"]: 2},
        ),
    ).applyCommit()
    ...
    with pytest.raises(ActionFailed) as einfo:
        result = makeAction(
            ...
            args=TradeArgs(
                team=teamId,
                receiver=TEAM_ADVANCED,
                resources={entities["mat-bobule"]: 2},
            ),
        ).applyCommit()
    ...
    with pytest.raises(ActionFailed) as einfo:
        result = makeAction(
            ...
            args=TradeArgs(
                team=teamId,
                receiver=TEAM_ADVANCED,
                resources={entities["pro-bobule"]: 20},
            ),
        ).applyCommit()
...
def test_unknownResource():
    ...
    with pytest.raises(ActionFailed) as einfo:
        result = makeAction(
            ...
            entities=entities,
            args=TradeArgs(
                team=teamId, receiver=TEAM_ADVANCED, resources={entities["pro-kuze"]: 2}
            ),
        ).applyCommit()
