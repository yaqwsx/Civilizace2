...
def test_withdraw():
    ...
    teamState.resources.update(sampleStorage)
    ...
    assert teamState.resources[entities.resources["mat-drevo"]] == 8
    assert teamState.resources[entities.work] == 98

    result = action.commitThrows(throws=0, dots=0)
    assert teamState.resources[entities.resources["mat-drevo"]] == 6

    args.resources[entities.resources["mat-drevo"]] = 3
    args.resources[entities.resources["mat-bobule"]] = 5
    result = action.commitThrows(throws=0, dots=0)
    args.resources[entities.resources["mat-drevo"]] = 3
    args.resources[entities.resources["mat-bobule"]] = 0
