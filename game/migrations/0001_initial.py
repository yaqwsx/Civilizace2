# Generated by Django 3.0.6 on 2021-05-18 09:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('id', 'version'), name='entitymodel_pk'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='assignedtask',
            name='tech',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.TechModel'),
        ),
    ]
