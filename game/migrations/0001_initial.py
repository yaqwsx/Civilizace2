# Generated by Django 3.0 on 2020-05-21 22:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('items', models.ManyToManyField(to='game.TechStorageItem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='resourcestorage',
            name='items',
            field=models.ManyToManyField(to='game.ResourceStorageItem'),
        ),
        migrations.AddField(
