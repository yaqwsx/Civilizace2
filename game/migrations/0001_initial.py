# Generated by Django 3.0 on 2020-05-13 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='build', to='game.TechModel')),
                ('data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.GameDataModel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.GameDataModel')),
                ('die', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.DieModel')),
                ('dst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dst', to='game.TechModel')),
                ('src', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='src', to='game.TechModel')),
            ],
            options={
                'abstract': False,
            },
