# Generated by Django 3.0.6 on 2021-06-11 09:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('resourcestorage_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='game.ResourceStorage')),
            ],
            options={
                'abstract': False,
            },
            bases=('game.resourcestorage',),
        ),
        migrations.CreateModel(
            name='ResourceModel',
            fields=[
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.TaskModel'),
        ),
        migrations.AddField(
            model_name='assignedtask',
            name='team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance', models.IntegerField()),
                ('root', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.TechModel')),
            ],
            bases=('game.entitymodel',),
            managers=[
                ('manager', django.db.models.manager.Manager()),
