...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--tree", action='store_true', help="Build only the tree" )
    ...
    def handle(self, *args, **kwargs):
        ...
        buildTree = kwargs.get("tree", False)
        ...
        if kwargs.get("demo", False):
            ...
            builder.generateTechLabel(TechModel.objects.get(id="tech-alchymie"))
